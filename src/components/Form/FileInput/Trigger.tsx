...
export function Trigger() {
  ...
  return (
    ...
    >
      <div className="borde-zinc-50 dark:group-houver:bg-zinc-800 rounded-full border-6 bg-zinc-100 p-2 group-hover:border-violet-50 group-hover:bg-violet-100 dark:border-zinc-700 dark:bg-zinc-800 dark:group-hover:border-zinc-600 dark:group-hover:bg-zinc-700">
